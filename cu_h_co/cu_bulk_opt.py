...
output_dir = "cu_h_co/cu_bulk"
os.makedirs(output_dir, exist_ok=True)

# get Cu
with MPRester(api_key) as mpr:
    res = mpr.get_structure_by_material_id("mp-30")
...
# write KPOINTS
kpts = Kpoints.gamma_automatic(kpts=(12, 12, 12))   # Suggested by AI due to Reciprocal Density Rule
